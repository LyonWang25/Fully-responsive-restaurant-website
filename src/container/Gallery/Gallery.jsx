...
const Gallery = () => {
  ...
  <div className="app__gallery flex__center">
    <div className="app__gallery-content">
      ...
      <p className="p__opensans" style={{color:"#AAA", marginTop:'2rem'}}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
